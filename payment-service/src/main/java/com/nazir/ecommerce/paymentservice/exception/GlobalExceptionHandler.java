...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handle(PaymentNotFoundException ex)   { return build(404,"payment-not-found","Payment Not Found",ex.getMessage()); }
    @ExceptionHandler(DuplicatePaymentException.class)
    public ProblemDetail handle(DuplicatePaymentException ex)  { return build(409,"duplicate-payment","Duplicate Payment",ex.getMessage()); }
