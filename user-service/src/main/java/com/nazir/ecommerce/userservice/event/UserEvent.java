 ...
 * Include enough data so consumers don't need to call back:✓ userId, email, firstName — enough for notification-service
 * But don't include sensitive data: ✗ password, phone number — don't belong in events
