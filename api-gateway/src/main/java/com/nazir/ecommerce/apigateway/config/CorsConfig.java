 ...
 *
 * LEARNING POINT — Why configure CORS at the gateway?
 ...
 *
 * LEARNING POINT — CorsWebFilter (reactive) vs CorsFilter (servlet):
...
public class CorsConfig {
    ...
    public CorsWebFilter corsWebFilter() {
        ...
        config.setAllowedHeaders(List.of(
                ...
                "Accept", "Origin", "X-Auth-User-Id", "X-Request-Id"));
        config.setExposedHeaders(List.of(
                "X-Gateway-Service", "X-Request-Id", "X-RateLimit-Remaining"));
